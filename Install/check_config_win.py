...
key_path = 'SOFTWARE\\Mozilla\\NativeMessagingHosts\\SaveAssist'
...
for root in key_roots:
    key = winreg.OpenKey(getattr(winreg, root)+1, key_path,access=winreg.KEY_READ | winreg.KEY_WOW64_64KEY)
    try:
